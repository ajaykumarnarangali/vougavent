  ...
  return (
    <div className="relative w-full overflow-hidden h-[400px] sm:h-[450px] md:h-[500px]">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[rgba(31,64,123,0.3)] to-[rgba(31,64,123,0)] flex items-center justify-start">
        <motion.h1
          className="text-white font-bold px-6 sm:px-12 lg:px-20 py-2 sm:py-3 lg:py-4 text-2xl sm:text-3xl lg:text-4xl bg-[rgba(0,0,0,0.4)] max-w-full sm:max-w-[80%] md:max-w-[60%]"
