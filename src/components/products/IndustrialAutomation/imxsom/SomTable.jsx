...
import { somspecData } from '../../../../data/products/IndustrialAutomation/Som'

function SomTable() {
    return (
        <div className="bg-gray-50 lg:min-h-[90vh] px-5 mt-4 pb-6">
