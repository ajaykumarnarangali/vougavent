...
import { Industrial_display_specData } from "../../../../data/products/IndustrialAutomation/Idisplay" 

function DisplayTable() {
    return (
            <div className="bg-gray-50 lg:min-h-[90vh] px-5 mt-4 py-6">
                <div className="w-full max-w-7xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-200">
                        {Industrial_display_specData.map((item, index) => (
                            <div
                                key={item.domain}
